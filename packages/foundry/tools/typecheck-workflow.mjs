...
if(process.argv.length!==4)throw Error('Usage: node packages/foundry/tools/typecheck-workflow.mjs <installed-typescript.js> <installed-@types-directory>');
const ts=require(resolve(process.argv[2]));
const files=['packages/foundry/src/workflow/cli.ts','packages/foundry/src/experiment/cli.ts','packages/foundry/src/business/cli.ts','packages/foundry/src/workbench/server.ts','packages/foundry/src/workbench/prepare-live.ts','packages/foundry/src/venture/cli.ts','packages/foundry/src/operations/cli.ts'];
