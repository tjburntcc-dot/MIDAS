...
const files=['packages/foundry/src/workflow/cli.ts','packages/foundry/src/experiment/cli.ts','packages/foundry/src/business/cli.ts','packages/foundry/src/workbench/server.ts','packages/foundry/src/workbench/prepare-live.ts'];
